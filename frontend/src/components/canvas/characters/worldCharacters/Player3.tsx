...
useFrame(() => {
  ...
  return (
    ...
    <>
    {/* amy */}
    {character === "amy" && otherUsers && otherUsers[1] ? <group ref={amyGroupRef}  scale={0.01}
    ...
    {/* mutant */}
    { character === 'mutant' && otherUsers && otherUsers[1] ? 
...
{ character === 'louise' && otherUsers && otherUsers[1] ? 
...
export default Player3Character